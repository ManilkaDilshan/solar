...
function DashboardCard08() {
  ...
  return (
    <div className="flex flex-col col-span-8 row-span-1 sm:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <header className="px-5 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100">Production Forcast</h2>
      </header>
